...
Ballet is a Latin (ID: `*Latn`) Display font designed by
[The Ballet Project Team](https://github.com/Omnibus-Type/Ballet). Its design is
based on classic Spencerian script style with a few whimsical twists presenting
an aristic and creative ballet dance stripe text expression. There are 3
families:

* `Ballet` - General typeface.
* `Ballet 16pt` - Smaller "sized" typeface.
* `Ballet 72pt` - Bigger "sized" typeface.
...
```
Title: Ballet Font
Creators: The Ballet Project Team
